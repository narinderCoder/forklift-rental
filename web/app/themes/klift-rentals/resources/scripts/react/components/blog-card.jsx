...
const Blogcard = ({ title, description, slug, readMore = false, blog,comments, parentComment, setParentComment, comment, setComment, handleSubmit ,commentCounts,loadMoreComments}) => {
  ...
  return (
    <div className="position-relative bg-tertiary blog-card">
      ...
      >
        ...
        <h6 className="blog-card-date-heading h6">{blog?.created_at.day}</h6>
          <p className="w-100 px-1 py-2 p3 text-center">{blog?.created_at.month} {blog?.created_at.year}</p>
        </div>
      ...
      >
        <div className="d-flex flex-column flex-md-row align-items-md-center gap-md-5 gap-3">
          <div className="d-flex align-items-center gap-1 p2">
            ...
            <p className="text-secondary">{blog?.author?.name}</p>
          </div>
          ...
          <div className="d-flex align-items-center gap-1 p2">
            ...
            <p className="text-secondary">{blog?.comment_count} Comments</p>
          </div>
        </div>
        <a
          href={`/blogs/${slug}`}
      ...
      <div className={`${readMore ? "d-block" : "d-none"}`}>
        ...
        {(comments?.length) < parseInt(commentCounts) ? (
                <div className="w-100 d-flex flex-column align-items-center justify-content-between">
                  <button className="btn-secondary bg-primary text-white" onClick={()=>loadMoreComments()}>Show More Comments</button>
                </div>
            ): null}
      </div>
    </div>
...
{/* <div className="position-relative bg-tertiary blog-card">
        ...
        <div className="blog-card-content col-md-10 col-12 offset-md-1">
          ...
          <div className="d-flex flex-column h-100 gap-4 justify-content-between">
            <div>
              ...
              <BlogComment cmt={comment} setComment={setComment} parent={0} handleSubmit={() => handleSubmit(0)} readMore={readMore}/>
          </div>
        </div>
      </div>
      <hr /> 
      ...
      <div
        className="d-flex flex-column justify-content-between w-100 flex-md-row align-items-md-center px-md-4"
        style={{ gap: "2rem", paddingTop: "1.5rem" }}
      >
        <div
        ...
        >
          ...
          <div className="d-flex align-items-center gap-1 p2">
            ...
            <p className="text-secondary">{blog?.comment_count?.approved} Comments</p>
          </div>
        </div>
        <a
          href={`/${blog.slug}`}
