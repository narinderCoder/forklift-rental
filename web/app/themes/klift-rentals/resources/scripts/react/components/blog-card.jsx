import BlogComments from "../pages/SingleBlog/BlogComments";
import BlogComment from "./BlogComment";

const Blogcard = ({ title, description, slug, readMore = false, blog,comments, comment, setComment, handleSubmit }) => {
  return (
